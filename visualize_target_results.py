#!/usr/bin/env python3
"""
Visualize Target Evaluation Results - Separate Images
"""
...
bars1 = ax1.bar(x - width/2, df['semantic_P@5']*100, width, label='Semantic Search', 
                color='#27ae60', alpha=0.85)
bars2 = ax1.bar(x + width/2, df['tfidf_P@5']*100, width, label='TF-IDF Baseline',
...
bars1 = ax2.bar(x - width/2, df['semantic_P@10']*100, width, label='Semantic Search', 
                color='#2ecc71', alpha=0.85)
bars2 = ax2.bar(x + width/2, df['tfidf_P@10']*100, width, label='TF-IDF Baseline',
...
bars = ax3.bar(['Semantic\nSearch', 'TF-IDF\nBaseline'], [sem_p5_avg, tfidf_p5_avg],
               color=['#27ae60', '#e67e22'], alpha=0.8, width=0.5)
...
bars = ax4.bar(['Semantic\nSearch', 'TF-IDF\nBaseline'], [sem_p10_avg, tfidf_p10_avg],
...
# ============================================================================
# 6. Win/Loss Analysis for both P@5 and P@10
# ============================================================================
...
bars1 = ax6.bar(x - width/2, [wins_p5, ties_p5, losses_p5], width, label='Precision@5',
                color=['#27ae60', '#f39c12', '#e67e22'], alpha=0.8)
bars2 = ax6.bar(x + width/2, [wins_p10, ties_p10, losses_p10], width, label='Precision@10',
                color=['#2ecc71', '#f39c12', '#e74c3c'], alpha=0.8)

ax6.set_ylabel('Number of Queries', fontweight='bold', fontsize=13)
ax6.set_title('Win/Tie/Loss Analysis (Semantic vs TF-IDF)', fontweight='bold', fontsize=16, pad=20)
ax6.set_xticks(x)
